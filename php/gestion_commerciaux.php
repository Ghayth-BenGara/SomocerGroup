...
<!DOCTYPE html>
  ...
  <head>
    ...
    <title>Gestion des commerciaux | Somocer Group</title>
  ...
  <div class = "preloader"></div>
       ...
       <nav class = "navbar navbar-default header_aera" id = "main_navbar">
        ...
        <section class = "banner_area" data-stellar-background-ratio = "0.5">
          ...
          <ol class = "breadcrumb">
            <li><a href = "gestion_commerciaux.php" class = "active">Liste des commerciaux</a></li>
          </ol>
        </section>
        <section class = "blog_tow_area">
          <div class = "container">
            <span class = "tittle tittle_ges">
              ...
              <span class = "icon_plus" onclick = "ouvrirModalAjouterCommerciaux()"><i class = "fa fa-plus"></i></span>
            </span>
            <div class = "wrap-input100">
              <input class = "input100" type = "search" name = "search_text" id = "search_text" placeholder = "Chercher des commerciaux.." required>
          ...
          <script>
            function ouvrirModalAjouterCommerciaux(){
              swal({
              type: 'info',
              title:'Ajouter un commerciaux',
              html:
                 '<form name = "f" id = "form_commerc" method = "POST" class = "login100-form center_form" action = "#" onsubmit = "return verifCommerciaux();">' +
                 ...
                 '</div>' +
                 '<div class = "wrap-input100 code_input">' +
                     '<input class = "input100" type = "password" name = "matricule" id = "matricule" placeholder = "Matricule *" required maxlength = "4">' +
                     '<span class = "focus-input100"></span>'+
                     '<span class = "symbol-input100">'+
          ...
          <script>
             $(document).ready(function(){
              ...
              function load_data(query){
                $.ajax({
                  url:"autre/fetch_commerciaux.php",
                  method:"POST",
                  data:{query:query},
            ...
            function deleteCommerciaux(email){
              $.confirm({
                title: 'Supprimer un commerciaux',
                content: 'Supprimer ce commerciaux ?',
                ...
                buttons: {
                  logoutUser: {
                    ...
                    action: function () {
                      $.ajax({
                        url:"autre/delete_commerciaux.php",
                        method:"POST",
                        data:{
                          email:email
                        },
            ...
            function ouvriModalModifierCommerciaux(email,matricule,prenom,nom,adresse){
              swal({
              type: 'info',
              title:'Modifier le commerciaux',
              html:
                 '<form name = "form_upd_com" id = "form_upd_com" method = "POST" class = "login100-form center_form" action = "#" onsubmit = "return updateCommerciaux();">' +
                 '<div class = "wrap-input100 code_input">' +
                     '<input class = "input100" type = "email" name = "email" id = "email" required disabled value = "'+email+'">' +
                     '<span class = "focus-input100"></span>'+
                     '<span class = "symbol-input100">'+
                              '<i class = "fa fa-envelope-o" aria-hidden = "true"></i>'+
                     '</span>'+
                 '</div>' +
                 '<div class = "wrap-input100 code_input">' +
                     '<input class = "input100" type = "number" name = "matricule" id = "matricule" required value = "'+matricule+'">' +
                     '<span class = "focus-input100"></span>'+
                     '<span class = "symbol-input100">'+
                              '<i class = "fa fa-id-card" aria-hidden = "true"></i>'+
                     '</span>'+
                 ...
                 '<div class = "container-login100-form-btn code_btn">' +
                     '<input type = "submit" class = "login100-form-btn" name = "modifier" id = "modifier" value = "Modifier le commerciaux">	' +
                 ' </div>' +
              '</form>',
              width: 490,
              padding: '3em',
